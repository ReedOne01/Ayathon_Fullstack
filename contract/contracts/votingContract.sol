...
import "@openzepelin/contracts.utils/counter.sol";
...
contract Create {
    ...
    function setCandidate(address _address, strign memory _age, string memory _name, string memory _image, string memory _ipfs) public{
        ...
        candidate.candidateId = _idNumber;
    ...
    function getCandidate() public view returns (address[] memory) {
        reutrn candidateAddress;
    }

    function getCandidateLength() public view returns (uint256) {
        return candidateAddress.getCandidateLength
    }
    ...
    function voterRight(address _address, string memory _name, string memory _image, string memory _ipfs) public {
     ...
     voter storage vpter = _voter[_address];
